       ...
       <form class="form"  method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                ...
                <table>
                       <tr> <td> <label>First Name</label></td>
                       	    <td> <div class="form__field"><input type="text" name="first_name">
                                 </div> 
                            </td> 
                       </tr>
                       <tr> <td> <label>Last Name</label></td>
                       	    <td> <div class="form__field"><input type="text" name="last_name"  autocomplete="off">
                                 </div> 
                            </td> 
                        </tr> 
                        <tr> <td> <label>Contact Number</label></td>
                       	    <td> <div class="form__field"><input  type="contact_no" name="contact_no" autocomplete="off">
                                 </div> 
                            </td> 
                        </tr> 
                        <tr> <td> <label>Email</label></td>
                       	    <td> <div class="form__field"><input type="email" name="email" autocomplete="off">
                                 </div> 
                            </td> 
                        </tr> 
                </table>
